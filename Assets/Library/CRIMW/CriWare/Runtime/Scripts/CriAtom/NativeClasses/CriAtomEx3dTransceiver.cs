...
public class CriAtomEx3dTransceiver : CriDisposable
{
	 ...
	 * <para header='注意'>設定したパラメータを実際に適用するには、 CriWare.CriAtomEx3dTransceiver::Update 関数を呼び出す必要があります。</para>
	 * </remarks>
	 ...
	 * CriWare.CriAtomEx3dTransceiver::Update 関数を呼び出す必要があります。<br/>
	 ...
	 * <para header='注意'>設定したパラメータを実際に適用するには、CriWare.CriAtomEx3dTransceiver::Update 関数を呼び出す必要があります。<br/></para>
	 * </remarks>
	 * <seealso cref='CriAtomEx3dTransceiver::Update'/>
	 */
