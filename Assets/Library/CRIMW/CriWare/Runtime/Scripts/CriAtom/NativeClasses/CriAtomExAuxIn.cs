...
public class CriAtomExAuxIn : CriDisposable
{
	 ...
	 * <br/>
	 * 音声の再生を開始するにはCriWare.CriAtomExAuxIn::Start 関数を実行します。<br/>
	 * 入力する音声は CriWare.CriAtomExAuxIn::SetInputReadStream に指定するコールバック関数を
	 ...
	 * CriWare.CriAtomExAuxIn::Start を呼ぶ前に設定する必要があります。<br/></para>
	 * </remarks>
	 ...
	 * <param name='samplingRate'>サンプリング周波数</param>
	 * <remarks>
	 * <para header='説明'>CriWare.CriAtomExAuxIn::SetFormat で設定したフォーマット情報を取得します。<br/></para>
	 * </remarks>
	 ...
	 * （AuxIn作成時に指定する CriWare.CriAtomExAuxIn::Config 構造体
	 ...
	 * センドレベル値の範囲や扱いは、ボリュームと同等です。CriWare.CriAtomExAuxIn::SetVolume 関数を参照してください。</para>
	 * </remarks>
	 */
